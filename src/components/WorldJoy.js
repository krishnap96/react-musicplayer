...
const callumine = "callumine.mp3";
const whatdoumean = "whatdoumean.mp3";
const takeaway = "takeaway.mp3";
const beachh = "beachh.mp3";
const killsyou = "killsyou.mp3";
...
const TRACKS = [
  ...
  { id: 1, title: "Call You Mine" },
  { id: 2, title: "What Do You Mean" },
  { id: 3, title: "Takeaway" },
  { id: 4, title: "Beach House" },
  { id: 5, title: "Kills You Slowly" },
];
  ...
  render() {
    ...
    return (
      <>
        ...
        <div className="playerw">
          <ul className="tracklistw">{list}</ul>
          <TimeBar
