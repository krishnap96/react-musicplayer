...
const TRACKS = [
  ...
  { id: 1, title: "Senorita - (Camila Cabello, Shawn Mendes)" }
];
  ...
  componentDidUpdate(prevProps, prevState) {
    if (this.state.selectedTrack !== prevState.selectedTrack) {
      ...
      switch (this.state.selectedTrack) {
        ...
        case "Senorita - (Camila Cabello, Shawn Mendes)":
          track = senorita;
          break;
        default:
          break;
        ...
        <div className="w3-mobile">
          ...
          {this.state.player !== "stopped" && (
            <div className="buttons">
              ...
              <Link to="/Senorita.mp3" target="_blank" download>Download</Link>
